...
namespace EndorblastCore.Server
{
    class CharacterManager
    {
        ...
        public List<EndorblastCore.Lib.BasePlayer> Characters = new List<EndorblastCore.Lib.BasePlayer>();
        ...
        public EndorblastCore.Lib.BasePlayer GetConnection(NetConnection con)
        {
            foreach (var p in Characters)
                if (con == p.connection)
                    return p;
        ...
        public List<EndorblastCore.Lib.BasePlayer> GetPlayers()
        {
            var list = new List<EndorblastCore.Lib.BasePlayer>();
