...
**A:**
I don't see many server projects in C# on Github that is for `MonoGame` that are easy to use and just setup to do nearly anything you want to do with it. Since I plan to make everything from scratch with the server it will also come as a helpful base for others projects that is working in `MonoGame`. I am making the server to work with physics because its a side scroller it should be easy to edit to make it work as a top down instead if you set your mind to it. Also if you want the server to support other types make it! Make a fork and do everything there then send a pull request.
...
<h2 name="#lisence">License Questions</h2>
