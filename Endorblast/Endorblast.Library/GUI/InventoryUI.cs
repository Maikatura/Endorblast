...
namespace Endorblast.Library.GUI
{
    class InventoryUI
    {
        ...
        {
            Sprite panelSprite = ContentLoader.LoadSprite("/Textures/Misc/UI/Login/UI_Inventory.png");
            slotIcon = ContentLoader.LoadSprite("/Textures/Misc/UI/Login/UI_Panel.png");
            Sprite silverSprite = new Sprite(Core.Content.LoadTexture("Content/Textures/Spritesheets/Items/Currency/Currency.png"));
            Sprite premiumSprite = new Sprite(Core.Content.LoadTexture("Content/Textures/Spritesheets/Items/Currency/CurrencyPremium.png"));
