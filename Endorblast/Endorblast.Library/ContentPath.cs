...
namespace Endorblast.Library
{
    ...
    {
        public static string spritePath = "/Textures";
    ...
    class ContentPath
    {
        ...
        // Shortcuts
        public string clothPath = $"{PathInfo.spritePath}/Spritesheets/Player/Clothes";
        public string hairPath = $"{PathInfo.spritePath}/Spritesheets/Player/Hair";
        ...
        // Start up Screen
        public string splashScreen_Sprite = $"{PathInfo.spritePath}/Logos/Splashscreen1.png";
