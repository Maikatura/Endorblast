...
{
    public class ParallaxBackground : Component, IUpdatable
    {

        public Entity bgObject;
        SpriteRenderer renderer;
        BasePlayer myPlayer;

        private float parallexEffect = 0.9f;
        ...
        public ParallaxBackground(List<ParallaxBGSprite> lists)
        {
            ...
            foreach (var item in lists)
            {
                ...
                item.renderer.RenderLayer = 200 + currentBG;
