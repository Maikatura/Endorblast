...
using System.Collections.Generic;
using Endorblast.DB.ImGui.Thing;
...
namespace Endorblast.DB.ImGui
{
    public class ImguiComponent
    {
        ...
        public ImguiComponent(GraphicsDeviceManager graphics, Game game)
        {
            this._graphics = graphics;
            this.Game = game;
            Elements = new List<Action>();
        }
        ...
        public static IntPtr TexToIntPtr(Texture2D texture, ImguiComponent component)
        {
