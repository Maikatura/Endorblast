...
namespace Endorblast.Lib.GUI
{
    class CharacterSelectionUI
    {
        ...
        private static void LoadCharaID(Scene scene, int id)
        {
            ...
            dummyPlayer.GetComponent<PlayerAnimationsComp>().LoadSet(chara.hairStyle);
            dummyPlayer.GetComponent<PlayerAnimationsComp>().LoadHair(1);
        ...
        private static void JoinGame(int charaID)
        {
            ...
            StateManager.Instance.SetGameState(CurrentGameState.PlayingState);
        }

        private static void LoadCharacterCreation()
        {
            StateManager.Instance.SetGameState(CurrentGameState.CharacterCreation);
        }
